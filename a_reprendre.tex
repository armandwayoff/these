...
Enfin, concernant la proposition précédente $\dim\mathcal H^\ensdiamantplat=4g$, le résultat découle bien du théorème de somme orthogonale, mais la preuve gagnerait à éviter le simple comptage \og inconnues--équations \fg{}. La justification rigoureuse est directement
\[
2A
=
\dim\Image(\grad^\ensdiamantplat)
+\dim\Image(\rot^\ensdiamantplat)
+\dim\mathcal H^\ensdiamantplat,
\]
puis
\[
\dim\Image(\grad^\ensdiamantplat)
...
=2A-2(S+F-2)=4g.
\]
Il faudrait aussi expliciter que la surface est connexe et orientable, hypothèses utilisées par la formule $\chi=2-2g$.