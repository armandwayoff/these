...
\subsection{Compositions of the discrete operators \cite[Sec. 4.2]{delcourte_discrete_2007}}
...
\]
\begin{remarque}
La matrice $\rotmat^\top_\ensdiamant \masse_\ensdiamant$ est symétrique positive mais pas définie. Néanmoins, cela n'est pas grave car la méthode converge à un vecteur du noyau de $\gradmat_\ensdiamant$ près. Or le noyau de $\gradmat_\ensdiamant$ contient l'homologie ainsi que des modes hyper-oscillants. De plus, la composante dans le noyau de $\gradmat$ est préservée dans toutes les étapes du gradient conjugué. En prenant comme solution initiale un vecteur nul, cela nous assure de n'obtenir aucun de ces modes tout en convergeant. 
\end{remarque}