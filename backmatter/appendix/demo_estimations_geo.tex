...
Assume $\surflisse$ and $\surfpoly$ are as described in \Cref{sec:triangulations}. The map $\fonctionens[\projvariete]{\surfpoly}{\surflisse}$ is bijective (see \Cref{lemme:fermi_coordinates}). For the oriented distance function to $\surflisse$ defined by \ref{eq:def_oriented_distance}, we have the estimate
\[
