...
\node[myblue,above=8pt] at (fG2) {\contour{mylightblue!50!white}{$\primalplat{K}$}};
\node[myred, below=6pt] at (fG2) {\contour{mylightblue!50!white}{$x_{\primalplat{K}}$}};
...
\node[mygreen] at ($(K)!0.5!(L)$) {\contour{mylightgreen!80!white}{$\diamantplat{D}$}};
...
\node at ($(mainP.center)+(-50:1.2)$) {\contour{white}{$\surfpoly$}};
\node[myblue] at ($(mainP.center)+(135:1.8)$) {$\ensprimalplat$};