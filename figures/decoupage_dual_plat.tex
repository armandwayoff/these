...
\node[myblue, above=6pt] at (fO) {\contour{mylightred!50!white}{$x_{\mailleduale{K}}$}};

\node[myred, below=5pt] at (G1) {$s_i$};
\node[below=5pt] at (M2) {\contour{white}{$m_i$}};
\node[myred, below=5pt] at (G2) {$s_{i+1}$};
...
\node[myred, left=5pt] at ($(G1)!0.5!(M1)$) {$\mailledualeplate{K}$};
