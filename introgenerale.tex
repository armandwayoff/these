...
\]
où $\varphi$ et $\psi$ sont des fonctions scalaires et $\vect{r}$ une fonction vectorielle appartenant au noyau du laplacien. 
\begin{figure}[H]
    \centering
