...
\filldraw[mygreen, draw=mydarkgreen, opacity=0.8, visible on=<4->] (J) -- (K) -- (I) -- (L) -- cycle;
...
\node[mydarkgreen] at ($(fF1G5)+(180:6pt)$) {$\diamantplat{D}$};
}
